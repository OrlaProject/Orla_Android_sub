 ...
 */
class OrderFinishListFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        orderlist.add(OrderListData("이상윤님,친환경 사과 주스 x1","수령완료"))
        orderlist.add(OrderListData("배선영님, 해커톤 샌드위치 x1","수령완료"))
        orderlist.add(OrderListData("이소희님, 오렌지 샐러드x1","수령완료"))
        orderlist.add(OrderListData("최다예님, 친환경 사과 주스 x1","수령완료"))
        orderlist.add(OrderListData("하승완님, 해커톤 샌드위치 x1","수령완료"))
